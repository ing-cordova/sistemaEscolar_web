...
%>
	<script type="text/javascript">
		...
		//Funci�n que cargar� los datos que seleccionemos en la tabla 1.
		function CargarDatos(){

			//Declaraci�n de variables recolectoras.
			var RowIdx;
			var id, Materia;
			...
			//Ciclo de iteraci�n de datos recogidos.
			for(i = 0; i < rows.length ; i++){
				rows[i].onclick = function(){
					...
					if(id > 0){
						console.log(id);
						console.log(Materia);
						//Creando el bot�n de eliminar cada fila que se seleccione.
